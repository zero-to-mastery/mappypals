...
const defaultContainer = ({children}) => <div className="search-engine">{children}</div>;
...
class FriendSearch extends Component {
  ...
  onChange = e => {
    ...
    switch(filterType) {
        case 'country':
            filteredFriends.push(friends.filter(
                friend =>
                    friend.country.toLowerCase().indexOf(userInput.toLowerCase()) > -1
            ));
            break;
        ...
        case 'interests':
            filteredFriends.push(friends.filter(
                friend =>
                    friend.interests.toLowerCase().indexOf(userInput.toLowerCase()) > -1
            ));
            break;
        default:
            ...
            <ul className="friends">
                ...
                return (
                    <li
                        ...
                        onClick={onClick}
                    >
                        <img width="50" src={`https://robohash.org/${index}?size=50x50`} 
                            alt={first.substr(-1)==='s' ? `${first}' photo` : `${first}'s photo`}/>
            ...
            FriendsListComponent = (
                <ul className="friends">
                    <li
                        ...
                        onClick={onClick}
                    >
                    <img width="50" src={`https://robohash.org/${friend.id}?size=50x50`} 
                        alt={friend.firstname.substr(-1)==='s' ? `${friend.firstname}' photo` : `${friend.firstname}'s photo`}/>
            ...
            <SearchStyles>  
                ...
                <DropDown>
                    <select onChange={this.onMenuSelect}>
                        ...
                        <option value="other interests">Other Filters</option>
                    </select>
                    <input
                        type="text"
